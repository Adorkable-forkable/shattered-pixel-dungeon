...
public class SPDSettings extends GameSettings {
	...
	// can return null because we need to directly handle the case of landscape not
	// being set
	...
	public static final String KEY_CONSUME_ANKH = "consume_ankh";
	public static final String KEY_HUNGER = "hunger";

	public static void consumeAnkh(boolean value) {
		Difficulty.INSTANCE.consumeAnkh(value);
		put(KEY_CONSUME_ANKH, value);
	}

	public static boolean consumeAnkh() {
		return getBoolean(KEY_CONSUME_ANKH, true);
	}

	public static void hunger(boolean value) {
		Difficulty.INSTANCE.hunger(value);
		put(KEY_HUNGER, value);
	}

	public static boolean hunger() {
		return getBoolean(KEY_HUNGER, true);
	}
